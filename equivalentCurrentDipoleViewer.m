...
%                     'FaceColor','interp','FaceLighting','phong','LineStyle','none','FaceAlpha',0.25,'SpecularColorReflectance',0,...
%                     'SpecularExponent',50,'SpecularStrength',0.5,'Parent',obj.hAxes);
            obj.hCortex = patch('vertices',obj.hmObj.cortex.vertices,'faces',obj.hmObj.cortex.faces,'FaceColor',skinColor,...
                'FaceLighting','phong','LineStyle','none','FaceAlpha',0.25,'SpecularColorReflectance',0,...
                'SpecularExponent',50,'SpecularStrength',0.5,'Parent',obj.hAxes);
            %camlight(0,180)
            camlight(0,0)
            ...
            set(obj.hFigure,'Visible',visible,'userData',obj,'Name',[figureTitle ' ' objName]);
            rotate3d
            drawnow
        end
        %%
